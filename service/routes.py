...
def list_products():
    ...
    This endpoint will read all matching products in DB
    """
    ...
    products_lst = [product.serialize() for product in products]
    app.logger.info(f"Returning {len(products_lst)}")
    return products_lst, status.HTTP_200_OK
